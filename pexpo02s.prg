...
//		end
		...
		*-----------------------------------------------------------------------------------------------NRO NFE
		...
		GravaTXT(20,;//........................................1.Cod.Registro
					...
					str(nModFrete							,01)+;	//.13.Modalidade Frete 0=não é frete ???? => str(TR_TIPO,1)
		...
		*---------------------------------------------------------------pagina 10 layout PH
		...
		vIcms[6,1]:=nVlrCtb //............SAG SÓ TEM PRODUTOS ISENTOS
...
//------------> 29 Quando é SPED não gera
		...
		Gera30(cModDNF,NFC->NF_FATUR,NFC->NF_EMIT)//-> 30 Registro tanto de Entrada e Saída
...
//	Gera38(PEDCAB->PC_FATUR, '', aFAT) // Entrada e saida (PAGINA 14) - Faturamento (E/S)
		...
		if !NFC->NF_FLCAN // Somente NF normal -> excluir geração Reg 60 a 69 de NF cancelada
