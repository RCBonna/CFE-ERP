*-----------------------------------------------------------------------------*
function CFEP4341(VM_P1)	//	<MENU>-Comparativo Precos								*
...
@19,20 say 'Com Prod.Zerado ?.:' get VM_FLAG[1] pict masc(01) valid VM_FLAG[1]$'SN'
@19,50 say 'Impr % Diferenca?.:' get VM_FLAG[7] pict masc(01) valid VM_FLAG[7]$'SN'
read
...
*-----------------------------------------------------------------------------*
function CFEP43411() // por grupo
VM_GRUPO=left(str(PR_CODGR,6),2)
VM_PAG=pb_pagina(VM_SISTEMA,VM_EMPR,ProcName(),VM_REL,VM_PAG,'CFEP4341A',VM_LAR)
...
??if(VM_FLAG[3],I15CPP,'')+'Complemento'+space(33)
??if(VM_FLAG[3],C15CPP,'')
??'Valor Custo'+space(4)
??'Valor Venda'
if VM_FLAG[7]=='S'
...
*-----------------------------------------------------------------------------*
function CFEP4341I() // impressao linha
VM_PAG=pb_pagina(VM_SISTEMA,VM_EMPR,ProcName(),VM_REL,VM_PAG,'CFEP4341A',VM_LAR)
